...
/**
 * This is the extension manager of the Recentlyviewedaddon extension.
 */
public class RecentlyviewedaddonManager extends GeneratedRecentlyviewedaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RecentlyviewedaddonManager.class.getName());
	 ...
	 */
	public static RecentlyviewedaddonManager getInstance()
	{
		return (RecentlyviewedaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				RecentlyviewedaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecentlyviewedaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RecentlyviewedaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RecentlyviewedaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RecentlyviewedaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
