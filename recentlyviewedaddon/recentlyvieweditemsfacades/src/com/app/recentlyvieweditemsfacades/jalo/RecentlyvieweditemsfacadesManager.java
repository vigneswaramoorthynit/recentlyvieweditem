...
/**
 * This is the extension manager of the Recentlyvieweditemsfacades extension.
 */
public class RecentlyvieweditemsfacadesManager extends GeneratedRecentlyvieweditemsfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(RecentlyvieweditemsfacadesManager.class);
	 ...
	 */
	public static RecentlyvieweditemsfacadesManager getInstance()
	{
		return (RecentlyvieweditemsfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RecentlyvieweditemsfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecentlyvieweditemsfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of RecentlyvieweditemsfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of RecentlyvieweditemsfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of RecentlyvieweditemsfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
