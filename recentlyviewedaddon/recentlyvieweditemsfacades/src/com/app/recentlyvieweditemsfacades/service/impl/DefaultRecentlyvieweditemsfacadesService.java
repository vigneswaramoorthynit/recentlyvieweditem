...
public class DefaultRecentlyvieweditemsfacadesService implements RecentlyvieweditemsfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRecentlyvieweditemsfacadesService.class);
	...
	{
		return DefaultRecentlyvieweditemsfacadesService.class.getResourceAsStream("/recentlyvieweditemsfacades/sap-hybris-platform.png");
	}
